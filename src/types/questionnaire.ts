...
export const QUESTIONNAIRE_STEPS: QuestionnaireStep[] = [
...

  {
    ...
    section: 'fiduciaries',
    title: 'Who should be your Healthcare Proxy?',
    subtitle:
      'Your healthcare proxy will make medical decisions for you if you are unable to communicate.',
    estimatedMinutes: 1,
    fields: [
      {
        name: 'heading_hcp_primary',
        label: 'Primary Healthcare Proxy',
        type: 'heading',
        width: 'full',
      },
      {
        ...
        type: 'text',
        required: true,
        placeholder: "Proxy's full legal name",
        width: 'half',
      },
      {
      ...
      },
      {
        ...
        label: 'Alternate Healthcare Proxy',
        type: 'heading',
        width: 'full',
      },
      {
        ...
        label: 'Full Name',
        type: 'text',
        placeholder: "Alternate proxy's full name",
        width: 'half',
      },
      {
      ...
      },
      {
        ...
        label: 'Authorize proxy to receive medical records (HIPAA)?',
        type: 'yesno',
        defaultValue: true,
        width: 'full',
      },
    ...
    fields: [
      {
        ...
        options: [
          ...
          {
            label: 'Undecided — let my proxy decide',
            value: 'undecided',
          },
        ],
      },
