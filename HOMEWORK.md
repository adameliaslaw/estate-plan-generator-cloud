...
| # | Item | Notes |
|---|------|-------|
| **B1** | **Lift the Rule 7 suspension in `CLAUDE.md`.** | The block's own lift condition is **met**: #255 (`a2b7162`), #256 (`f8820e7`), #257 (`3747e5c`) are all on `main`. It was added 2026-08-02 at Adam's direction, so Adam confirms the lift. Whoever removes it says so in the commit message, per the block. |
