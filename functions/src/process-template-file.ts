...
- Hardcoded addresses next to fiduciary names are client data — ALWAYS detect them as variables using the .address field.

CRITICAL MAPPING RULES — FUNERAL/SPECIAL PROVISIONS:
- Funeral wishes, burial preferences, or cremation instructions → specialConsiderations.funeralWishes (NOT petDetails)
