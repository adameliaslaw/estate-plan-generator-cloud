...
export const VARIABLE_TO_QUESTIONNAIRE_MAP: Record<string, VariableMapping> = {
  ...
  'fiduciaries.executor.primary.address':               { variable: 'fiduciaries.executor.primary.address',               section: 'Fiduciaries', label: 'Primary Executor Address',     fieldPath: 'fiduciaries.executor.primary.address' },
  ...
  'fiduciaries.executor.alternate.address':             { variable: 'fiduciaries.executor.alternate.address',             section: 'Fiduciaries', label: 'Alternate Executor Address',   fieldPath: 'fiduciaries.executor.alternate.address' },
  ...
  'fiduciaries.trustee.primary.address':                { variable: 'fiduciaries.trustee.primary.address',                section: 'Fiduciaries', label: 'Primary Trustee Address',      fieldPath: 'fiduciaries.trustee.primary.address' },
  ...
  'fiduciaries.trustee.alternate.address':              { variable: 'fiduciaries.trustee.alternate.address',              section: 'Fiduciaries', label: 'Alternate Trustee Address',    fieldPath: 'fiduciaries.trustee.alternate.address' },
  ...
  // Healthcare proxy uses .agent/.alternateAgent to match the Fiduciaries type and the questionnaire schema.
  'fiduciaries.healthcareProxy.agent':                  { variable: 'fiduciaries.healthcareProxy.agent',                  section: 'Fiduciaries', label: 'Primary Healthcare Proxy',     fieldPath: 'fiduciaries.healthcareProxy.agent' },
  'fiduciaries.healthcareProxy.agent.address':          { variable: 'fiduciaries.healthcareProxy.agent.address',          section: 'Fiduciaries', label: 'Primary Healthcare Proxy Address', fieldPath: 'fiduciaries.healthcareProxy.agent.address' },
  'fiduciaries.healthcareProxy.alternateAgent':         { variable: 'fiduciaries.healthcareProxy.alternateAgent',         section: 'Fiduciaries', label: 'Alternate Healthcare Proxy',   fieldPath: 'fiduciaries.healthcareProxy.alternateAgent' },
  'fiduciaries.healthcareProxy.alternateAgent.address': { variable: 'fiduciaries.healthcareProxy.alternateAgent.address', section: 'Fiduciaries', label: 'Alternate Healthcare Proxy Address', fieldPath: 'fiduciaries.healthcareProxy.alternateAgent.address' },
